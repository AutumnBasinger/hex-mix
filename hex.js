...
inventory.yellow = [255, 255, 0];
inventory.cyan = [0, 255, 255];
inventory.magenta = [255, 0, 255];
...
function saveName(){ //fix the object.values thing. find values in inventory
  dev.innerHTML = "The current color is: " + currentColor;
  if (currentColor === undefined) {
    ...
    inventoryBox.innerHTML = inventoryBox.innerHTML + "," + nameInput.value;
  }
};